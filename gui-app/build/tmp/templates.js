...
module.run(["$templateCache", function($templateCache) {
  ...
  $templateCache.put("modules/main/partial/index/index.html",
    ...
    "\n" +
    "                        <div class=\"col-sm-10\">\n" +
    "                            <input type=\"text\" class=\"form-control\" id=\"fCount\"\n" +
    ...
    "\n" +
    "                        <div class=\"col-sm-10\">\n" +
    "                            <input type=\"text\" class=\"form-control\" id=\"fCount2\"\n" +
    ...
    "\n" +
    "                        <div class=\"col-sm-10\">\n" +
    "                            <input type=\"text\" class=\"form-control\" id=\"fFactorAlpha\" ng-model=\"vm.parameters.alpha\">\n" +
    "                        </div>\n" +
    "                    </div>\n" +
    "                    <div class=\"form-group\">\n" +
    ...
    "\n" +
    "                        <div class=\"col-sm-10\">\n" +
    "                            <input type=\"text\" class=\"form-control\" id=\"fFactorBeta\" ng-model=\"vm.parameters.beta\">\n" +
    "                        </div>\n" +
    "                    </div>\n" +
    "                    <div class=\"form-group\">\n" +
    ...
    "\n" +
    "                        <div class=\"col-sm-10\">\n" +
    "                            <input type=\"text\" class=\"form-control\" id=\"fFactorGamma\" ng-model=\"vm.parameters.gamma\">\n" +
    "                        </div>\n" +
    "                    </div>\n" +
    "\n" +
    "                    <div class=\"form-group\">\n" +
    ...
    "\n" +
    "                        <div class=\"col-sm-10\">\n" +
    "                            <input type=\"text\" class=\"form-control\" id=\"fIterationsCount\"\n" +
